...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content" class="flex-grow-1">
        <nav class="navbar navbar-expand navbar-light bg-white border-bottom px-3">
            ...
            <span class="navbar-text fw-semibold d-none d-md-inline"><?= e($pageTitle) ?></span>
            <div class="ms-auto d-flex align-items-center gap-3">
                <span class="badge bg-primary text-capitalize"><?= e($role) ?></span>
                <span class="text-muted small d-none d-sm-inline"><?= e($_SESSION['full_name'] ?? '') ?></span>
